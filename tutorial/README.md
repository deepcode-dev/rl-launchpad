...
| [05-visualize-and-publish.md](05-visualize-and-publish.md) | Live viewers, video recording, benchmark plot, submission validation | `eval/view_native_v2.py`, `eval/record_native_video.py`, `eval/plot_benchmark.py`, `eval/validate_submission.py` |
